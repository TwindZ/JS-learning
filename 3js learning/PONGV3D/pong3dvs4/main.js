...
let paddle1_att = {x : -board.size / 2 + (board.thickness * 2), y : 0, width : board.thickness, height : 75, light_color:  0x0000ff, dead: false}
let paddle2_att = {x : board.size / 2 - (board.thickness * 2), y : 0, width : board.thickness, height : 75, light_color:  0xff0000, dead: false}
let paddle3_att = {x : 0, y : board.size / 2 - (board.thickness * 2), width : 75, height : board.thickness, light_color:  0xff0000, dead: false}
let paddle4_att = {x : 0, y : -board.size / 2 + (board.thickness * 2), width : 75, height : board.thickness, light_color:  0xff0000, dead: false}
let control = {w : false, s: false,  a : false, d: false, arrowUp : false, arrowDown : false, arrowLeft: false, arrowRight : false}
let ball_att = {x : 0, y : 0, dirX : 1, dirY : -1, speedX : 1, speedY : 0}
let gameInfo = {p1Lives : 1, p2Lives : 1, p3Lives : 1, p4Lives : 1, gameover : false, player_left: 4}
...
const p1light1 = new THREE.PointLight(paddle1_att.light_color, 40000, 1000)
...
const p1light2 = new THREE.PointLight(paddle1_att.light_color, 40000, 1000)
...
const p1light3 = new THREE.PointLight(paddle1_att.light_color, 40000, 1000)
...
const p2light1 = new THREE.PointLight(paddle2_att.light_color, 40000, 1000)
...
const p2light2 = new THREE.PointLight(paddle2_att.light_color, 40000, 1000)
...
const p2light3 = new THREE.PointLight(paddle2_att.light_color, 40000, 1000)
...
function goalDetection(){
	if(sphere.position.x < -board.size / 2 + board.thickness && paddle1_att.dead === false){
		gameInfo.p1Lives--
	...
	if(sphere.position.x > board.size / 2 - board.thickness && paddle2_att.dead === false){
		gameInfo.p2Lives--
	...
	if(sphere.position.y > board.size / 2 - board.thickness && paddle3_att.dead === false){
		gameInfo.p3Lives--
	...
	if(sphere.position.y < -board.size / 2 + board.thickness && paddle4_att.dead === false){
		gameInfo.p4Lives--
...
function sideRebound(){
	...
	if(sphere.position.y < -board.size / 2 + board.thickness && paddle4_att.dead === true){
		ball_att.dirY = 1
	}
	if(sphere.position.y > board.size / 2 - board.thickness && paddle3_att.dead === true){
		ball_att.dirY = -1
	}
	if(sphere.position.x < -board.size / 2  + board.thickness && paddle1_att.dead === true){
		ball_att.dirX = 1
	}
	if(sphere.position.x > board.size / 2 - board.thickness && paddle2_att.dead === true){
		ball_att.dirX = -1
	}
}

function paddleColision(){
	if(paddle1_att.dead === false && sphere.position.x - board.thickness <= paddle1.position.x + (board.thickness / 2) && sphere.position.y <= paddle1.position.y + paddle1_att.height / 2 && sphere.position.y >= paddle1.position.y - paddle1_att.height / 2){
		changeAngle()
		ball_att.dirX = 1
		level += level_inc
	}
	if(paddle2_att.dead === false && sphere.position.x + board.thickness >= paddle2.position.x - (board.thickness / 2) && sphere.position.y <= paddle2.position.y + paddle2_att.height / 2 && sphere.position.y >= paddle2.position.y - paddle2_att.height / 2){
		changeAngle()
		ball_att.dirX = -1
		level += level_inc
	}
	if(paddle3_att.dead === false && sphere.position.y + board.thickness >= paddle3.position.y - (board.thickness / 2) && sphere.position.x <= paddle3.position.x + paddle3_att.width / 2 && sphere.position.x >= paddle3.position.x - paddle3_att.width / 2){
		changeAngle()
		ball_att.dirY = -1
		level += level_inc
	}
	if(paddle4_att.dead === false && sphere.position.y - board.thickness <= paddle4.position.y + (board.thickness / 2) && sphere.position.x <= paddle4.position.x + paddle3_att.width / 2 && sphere.position.x >= paddle4.position.x - paddle4_att.width / 2){
		changeAngle()
		ball_att.dirY = 1
		level -= level_inc
	}
...
function controlDetection(){
	if(control.w === true && paddle1.position.y < board.size / 2 - paddle1_att.height / 2 - (board.thickness * 2.5))
	paddle1.position.y += 4
	if(control.s === true && paddle1.position.y > -board.size / 2 + paddle1_att.height / 2 + (board.thickness * 2.5))
	paddle1.position.y -= 4
	
	if(control.d === true && paddle3.position.x < board.size / 2 - paddle3_att.width / 2 - (board.thickness * 2.5))
	paddle3.position.x += 4
	if(control.a === true && paddle3.position.x > -board.size / 2 + paddle3_att.width / 2 + (board.thickness * 2.5))
	paddle3.position.x -= 4
	
	if(control.arrowUp === true && paddle2.position.y < board.size / 2 - paddle2_att.height / 2 - (board.thickness * 2.5))
	paddle2.position.y += 4
	if(control.arrowDown === true && paddle2.position.y > -board.size / 2 + paddle2_att.height / 2 + (board.thickness * 2.5))
	paddle2.position.y -= 4
	
	if(control.arrowRight === true && paddle4.position.x < board.size / 2 - paddle3_att.width / 2 - (board.thickness * 2.5))
	paddle4.position.x += 4
	if(control.arrowLeft === true && paddle4.position.x > -board.size / 2 + paddle3_att.width / 2 +(board.thickness * 2.5))
	paddle4.position.x -= 4
}
